import{r as ce,j as T,b as ft,e as ea,T as ta,a as na,f as er,g as ia,h as ra,B as Nn,P as sa,i as oa}from"./index-V_WygqoY.js";import{C as aa,a as ca,T as tr,b as ha,B as nr,I as ir,n as Dn}from"./index-2p_7-7zN.js";import{g as la}from"./__commonjsHelpers__-4gQjN7DL.js";import{p as ua}from"./Phone-Gdr6nsRz.js";import{h as rr}from"./home-main-BMAXBtk4.js";import"./Transition-825N8Tn4.js";const da=ce.createContext(null),Qr=da;function Zr(){return ce.useContext(Qr)}const fa=typeof Symbol=="function"&&Symbol.for,pa=fa?Symbol.for("mui.nested"):"__THEME_NESTED__";function ga(t,e){return typeof e=="function"?e(t):ft({},t,e)}function ma(t){const{children:e,theme:n}=t,i=Zr(),r=ce.useMemo(()=>{const s=i===null?n:ga(i,n);return s!=null&&(s[pa]=i!==null),s},[n,i]);return T.jsx(Qr.Provider,{value:r,children:e})}const sr={};function or(t,e,n,i=!1){return ce.useMemo(()=>{const r=t&&e[t]||e;if(typeof n=="function"){const s=n(r),o=t?ft({},e,{[t]:s}):s;return i?()=>o:o}return t?ft({},e,{[t]:n}):ft({},e,n)},[t,e,n,i])}function va(t){const{children:e,theme:n,themeId:i}=t,r=ea(sr),s=Zr()||sr,o=or(i,r,n),a=or(i,s,n,!0);return T.jsx(ma,{theme:a,children:T.jsx(ta.Provider,{value:o,children:e})})}const ya=["theme"];function _a(t){let{theme:e}=t,n=na(t,ya);const i=e[er];return T.jsx(va,ft({},n,{themeId:i?er:void 0,theme:i||e}))}var ar={};/**
 * @license
